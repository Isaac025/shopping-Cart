          ...
          >
            <div>
              <label htmlFor="fname" className="labell">
                FullName<span className="spann">*</span>
              </label>
              ...
              <p className={`${errors ? "text-red-600" : ""}`}>
            ...
            <div>
              <label htmlFor="password2" className="labell">
                Confirm Password<span className="spann">*</span>
              </label>
              <div className="relative">
                <BiLock color="darkred" className="input-icon" />
                <input
            ...
            <div>
              <label htmlFor="pno" className="labell">
                Phone Number<span className="spann">*</span>
              </label>
              <div className="relative">
                <BiPhone color="darkred" className="input-icon" />
                <input
                  type="text"
                  id="pno"
